...
def main():
    ...
    while True:
        ...
        if(opcaoMatriz == 1):
            ...
            df = pd.DataFrame([[qnt_unicas, qnt_repetidas]], columns=['Únicas', 'Repetidas'])
            ...
            details = {
                'Figurinhas': list(dict_keys),
                'Repetidas': list(dict_value)
            }
            ...
            if(relatorio == 1):
                album.create_missing_stickers_in_album_report(stickers.get_all_stickers())
                print('Relatório criado')
            elif(relatorio == 2):
                pass
            ...
            if (album.read_stickers_in_album_report()):
                ...
                print('Figurinhas: ' + str(len((album.read_stickers_in_album_report()[1:]))) + ' Unidades')
            else:
            ...
            if(album.read_repeated_stickers_report()):
                ...
                print('Figurinhas repetidas: ' + str(len((album.read_repeated_stickers_report()[1:]))) + ' Unidades')
            else:
            ...
            if(album.read_missing_stickers_in_album_report()):
                ...
                print('Figurinhas Faltantes: ' + str(len((album.read_missing_stickers_in_album_report()[1:]))) + ' Unidades')
            else:
